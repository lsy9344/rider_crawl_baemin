...
def test_baemin_job_ignores_coupang_email_2fa_payload() -> None:
    captured = {}
...
def test_crawl_coupang_job_allows_complete_email_2fa_from_payload() -> None:
    """Complete crawl payload email 2FA config is passed to the crawler."""
    captured = {}
...
def test_crawl_coupang_login_screen_passes_email_2fa_config_to_crawler() -> None:
    """Login-screen handling stays in the crawler, with inline auth config available."""
    captured = {}
