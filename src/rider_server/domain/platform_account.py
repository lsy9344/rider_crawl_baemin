...
class PlatformAccount:
    ...
    platform: Platform
    label: str
    username: str = ""  # 배민/쿠팡 로그인 ID
    password: str = ""  # 배민/쿠팡 로그인 비밀번호(DB 직접 저장)
    verification_email_address: str = ""  # 2차인증 이메일 주소
    verification_email_app_password: str = ""  # IMAP 앱 비밀번호(DB 직접 저장)
